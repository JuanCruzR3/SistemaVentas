...
namespace CapaPresentacion
{
    public partial class frmCompras : Form
    {
        ...
        private void btnagregarproducto_Click(object sender, EventArgs e)
        {
            ...
            // Validar formato de Precio Compra
            ...
            // Validar formato de Precio Venta
            ...
            if (!producto_existe)
            {
                dgvdata.Rows.Add(new object[]
                {
                    txtidproducto.Text,
                    txtproducto.Text,
                    preciocompra.ToString("N2", CultureInfo.CurrentCulture), // Formato con 2 decimales
                    precioventa.ToString("N2", CultureInfo.CurrentCulture),
                    txtcantidad.Value.ToString(),
                    (txtcantidad.Value * preciocompra).ToString("N2", CultureInfo.CurrentCulture)
                });
